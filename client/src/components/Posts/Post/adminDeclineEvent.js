...
import {updateDecline,deleteEvent} from '../../actions/eventPosts'
...
const EventPost = ({post,setCurrentId})=>{
    ...
    return(
        <Card className={classes.card}>
            ...
            <Button size ="small" color="primary" onClick={()=>EventDispatch(updateDecline(post._id,{event: post.event,description:post.description,date:post.date,duration:post.duration,approvel:'approved',selectedfile:post.selectedfile,conductor:post.conductor,Mtype:post.Mtype}),window.location.reload(false))} >
