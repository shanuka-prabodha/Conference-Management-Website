...
import EventPosts from './Posts/editorChangedConferencePosts';
import EventForm from './Forms/conferenceChangedForm';
import Styles from './style';
import {useDispatch} from 'react-redux';
import {getEditorconference} from './actions/conference';
        ...
        <AppBarComponent getUserType={userType}/>
            <Container maxwidth ='lg'>
                ...
                <AppBar className ={classes.appBar} position ="static" color ='inherit'>
                    ...
                    <Typography className={classes.heading} variant ="h2" align = "center">  Conference Details</Typography>
